...
| Thành phần | Vai trò |
|------------|---------|
| **Assign-refu-manager-service** | Mongo `ElectricBillRecord`, ingest checkbill, staging, worker đồng bộ hạn TT, gọi AutoCheck (`GET payment-due`, `POST /api/tasks` CPC khi 404). |
