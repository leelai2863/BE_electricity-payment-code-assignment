...
var HttpLogTransport = class {
  ...
  async sendBatch(entries) {
    ...
    let res;
    try {
      res = await undici.fetch(this.endpoint, {
        method: "POST",
        headers,
  ...
  async healthCheck() {
    try {
      ...
      try {
        const res = await undici.fetch(this.healthUrl, {
          method: "GET",
          dispatcher: this.dispatcher,
          signal: ac.signal
        });
...
exports.compactLogEntryForTransport = compactLogEntryForTransport;
exports.createSharedLogger = createSharedLogger;
exports.enterLogContext = enterLogContext;
exports.getLogContext = getLogContext;
exports.getSharedLogger = getSharedLogger;
exports.getTraceIdOrFallback = getTraceIdOrFallback;
exports.runWithLogContext = runWithLogContext;
exports.waitForLogBridgeReady = waitForLogBridgeReady;
exports.waitForSharedLoggerBroker = waitForSharedLoggerBroker;
